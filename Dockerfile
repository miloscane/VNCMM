...
RUN sed -i 's^<!-- end scripts -->^<script src="https://mobatec.nl/TEMP/docker.js"></script>^' /usr/share/novnc/vnc.html && \
    ...
    wget https://mobatec.nl/favicon/favicon-48.png && mv favicon-48.png /usr/share/novnc/app/images/icons/novnc-48x48.png && \
    wget https://mobatec.nl/favicon/favicon-60.png && mv favicon-60.png /usr/share/novnc/app/images/icons/novnc-60x60.png && \
    wget https://mobatec.nl/favicon/favicon-64.png && mv favicon-64.png /usr/share/novnc/app/images/icons/novnc-64x64.png && \
    wget https://mobatec.nl/favicon/favicon-72.png && mv favicon-72.png /usr/share/novnc/app/images/icons/novnc-72x72.png && \
    wget https://mobatec.nl/favicon/favicon-76.png && mv favicon-76.png /usr/share/novnc/app/images/icons/novnc-76x76.png && \
    wget https://mobatec.nl/favicon/favicon-96.png && mv favicon-96.png /usr/share/novnc/app/images/icons/novnc-96x96.png && \
    wget https://mobatec.nl/favicon/favicon-120.png && mv favicon-120.png /usr/share/novnc/app/images/icons/novnc-120x120.png && \
    wget https://mobatec.nl/favicon/favicon-144.png && mv favicon-144.png /usr/share/novnc/app/images/icons/novnc-144x144.png && \
    wget https://mobatec.nl/favicon/favicon-152.png && mv favicon-152.png /usr/share/novnc/app/images/icons/novnc-152x152.png && \
    wget https://mobatec.nl/favicon/favicon-192.png && mv favicon-192.png /usr/share/novnc/app/images/icons/novnc-192x192.png
